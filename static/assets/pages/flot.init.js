...
!function($) {
    ...
    FlotChart.prototype.createCombineGraph = function(selector, ticks, labels, datas) {
        ...
        FlotChart.prototype.init = function() {
          ...
          var datas = [20,30, 15];
          var colors = ["#61d7c7", "#7c6ae7", "#6cbafa"];
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


            //real time data representation
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#7c6ae7']);
            plot.draw();
            var $this = this;
            function updatePlot() {
          ...
          var donutcolors = ["#7c6ae7", "#6cbafa", "#61d7c7"];
